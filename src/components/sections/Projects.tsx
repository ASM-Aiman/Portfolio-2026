...
const projects: Project[] = [
  {
    ...
    githubUrl: 'https://github.com/asm-aiman/codex-reader',
    liveUrl: 'https://codex-reader.vercel.app',
    stars: 127,
    forks: 23,
    constellation: '♈',
  },
  {
    ...
    githubUrl: 'https://github.com/asm-aiman/vocabulary-arsenal',
    stars: 89,
    forks: 15,
    constellation: '♉',
  },
  {
    id: 'nocturne-ui',
    title: 'Nocturne UI',
    description: 'A dark-mode first component library for storytellers. Every shadow placed with intention.',
    tech: ['TypeScript', 'Tailwind', 'Storybook'],
    githubUrl: 'https://github.com/asm-aiman/nocturne-ui',
  ...
  {
    id: 'celestial-calc',
    title: 'Celestial Calculator',
    description: 'Planetary physics simulations and orbital mechanics visualizations.',
    tech: ['React', 'Canvas API', 'WebGL'],
    githubUrl: 'https://github.com/asm-aiman/celestial-calc',
    stars: 156,
    forks: 34,
    constellation: '♋',
  },
